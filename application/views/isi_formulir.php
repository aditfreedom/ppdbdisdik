...
<div class="content-header">
    ...
    <div class="container">
        ...
        <select <?=$disabled;?> class="form-control selectpicker" data-size="5" name="id_sekolah" data-style="btn-info" data-live-search="true">
    ...
    <div class="col">
        ...
        <input <?=$disabled;?> type="date" name="tanggal_lahir" value="<?php echo $data->tanggal_lahir;?>" class="form-control" required>
        </div>  
        </div>    
        </div>
  ...
  <div class="row">
    ...
    <div class="container">
        ...
        <select <?=$disabled;?> class="form-control" name="penghasilan_ibu_kandung" required>
    ...
    <div class="col">
        ...
        <select <?=$disabled;?> class="form-control" name="penghasilan_ayah" required>
  ...
  <div class="row">
    ...
    <div class="container">
        ...
        <select <?=$disabled;?> class="form-control" name="penghasilan_wali" required>
  ...
  <div class="row">
    ...
    <div class="container">
        ...
        <input <?=$disabled;?> type="text" name="no_kip" value="<?php echo $data->no_kip;?>"  class="form-control" placeholder="Beri Angka 0 Bila Tidak Ada" maxlength="50" required>
        </div>  

        <div class="form-group">
        <label for=""><b>NO PKH :</b></label>
        <input <?=$disabled;?> type="text" name="no_pkh" value="<?php echo $data->no_pkh;?>" class="form-control" placeholder="Beri Angka 0 Bila Tidak Ada" maxlength="50" required>
        </div>  
