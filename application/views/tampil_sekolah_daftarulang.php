<div class="content-wrapper">
 ...
 <div class="content-header">
    ...
    <table class="table table-hover" id="example">
          ...
          <tbody>
          <?php $i = 1; 
	        foreach ($tampil_sekolah as $data) : ?>
		      <tr class="nomor text-center">
            <th scope="row"><?php echo $i ;?></th>
            <td><a href="<?=base_url('home/approve_daftarulang_admin?id=').$data->id_sekolah?>"><?php echo $data->npsn;?></a></td>
            <td><a href="<?=base_url('home/approve_daftarulang_admin?id=').$data->id_sekolah?>"><?php echo $data->nama_sekolah;?></a></td>
		      </tr>
		<?php $i++; ?>
	<?php endforeach ;?>
          </tbody>
