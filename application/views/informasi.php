...
<head>
  ...
  <title>PPDB ONLINE KABUPATEN BIREUEN</title>
...
<body >
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <h3>Jadwal Seleksi <span>Penerimaan</span></h3><br>
          <table id="example" class="table table-bordered text-wrap" id="example" style="font-family: 'Varela Round', sans-serif;">
  ...
  <footer id="footer">
    ...
    <div class="container py-4">
      <div class="copyright">
        &copy; Copyright <strong><span>PPDB DISDIKBUD KAB. BIREUEN</span></strong>. All Rights Reserved
      </div>
      <div class="credits">
