<div class="content-wrapper">
  ...
  <div class="content">
    ...
    <table class="table table-hover" id="example">
      ...
      <tbody>
        <?php $i = 1;
        foreach ($tampilsetting as $data) : ?>
          <tr class="nomor text-center">
            <th scope="row"><?php echo $i; ?></th>
            <td><?php echo $data->tipe_setting; ?></td>
            <td><?php echo $data->status; ?></td>
            <td>
              <?php echo anchor('home/editsetting/' . $data->id_setting, '<div class="btn btn-success btn-sm"><i class="fa fa-edit"></i></div>') ?>
            </td>
          </tr>
          <?php $i++; ?>
        <?php endforeach; ?>
