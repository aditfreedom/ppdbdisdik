<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0 text-dark">KUOTA MANUAL</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">PPDB</a></li>
            <li class="breadcrumb-item active">Kuota Manual</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
  ...
  <div class="content">
    ...
    <table class="table table-hover" id="example">
      ...
      <tbody>
        <?php $i = 1;
        foreach ($kuota_manual as $data) : ?>
          <tr class="nomor text-center">
            <th scope="row"><?php echo $i; ?></th>
            <td><?php echo htmlentities($data->nama_sekolah); ?></td>
            <td class="font-weight-bold"><?php echo htmlentities($data->total); ?></td>
            <td><?php echo htmlentities($data->sisa_zonasi); ?></td>
            <td><?php echo htmlentities($data->sisa_afirmasi); ?></td>
            <td><?php echo htmlentities($data->sisa_pindahan); ?></td>
            <td><?php echo htmlentities($data->sisa_prestasi); ?></td>
            <td><?php echo htmlentities($data->sisa_umum); ?></td>
            <td class="font-weight-bold"><?php echo htmlentities($data->total_in); ?></td>
            <td >
              <?php echo anchor('home/editkuotamanual/' . htmlentities($data->id_kuota), '<div class="btn btn-success btn-sm"><i class="fa fa-edit"></i></div>') ?>
            </td>
          </tr>
          <?php $i++; ?>
        <?php endforeach; ?>
