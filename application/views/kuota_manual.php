      ...
      <tbody>
        ...
        foreach ($kuota_manual as $data) : ?>
          <tr class="nomor text-center">
            ...
            <td class="font-weight-bold"><?php echo $data->total; ?></td>
            ...
            <td class="font-weight-bold"><?php echo $data->total_in; ?></td>
            <td >
              <?php echo anchor('home/editkuotamanual/' . $data->id_kuota, '<div class="btn btn-success btn-sm"><i class="fa fa-edit"></i></div>') ?>
            </td>
          </tr>
          <?php $i++; ?>
        <?php endforeach; ?>
